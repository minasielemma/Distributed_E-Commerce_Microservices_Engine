...
export const authService = {
  ...
  // Tenant Management
  getTenants: (params = {}) => api.get('/auth/tenant/list/', { params }),
...
export const cartService = {
  ...
  addItemToCart: (product_id, quantity = 1, price = 0, variant_id = null) => 
    api.post('/cart/carts/add-item/', { product_id, quantity, price, variant_id }),
  ...
  addItemToWishlist: (product_id, note = '') => 
    api.post('/cart/wishlists/add-item/', { product_id, note }),
  ...
  getItemRequest: (id) => api.get(`/cart/item-requests/${id}/`),
  ...
  updateItemRequestStatus: (id, status, admin_response = '') => 
    api.post(`/cart/item-requests/${id}/update-status/?scope=shop`, { status, admin_response }),
  getItemRequestStats: (params = {}) => api.get('/cart/item-requests/stats/', { params }),
};
...
export const orderService = {
  ...
  dispatchOrder: (orderId, dispatchData = {}) => api.post(`/orders/${orderId}/dispatch/`, dispatchData),
  getOrders: (params = {}) => api.get('/orders/list/', { params }),
  getOrder: (id) => api.get(`/orders/${id}/`),
  getOutboxEvents: (params = {}) => api.get('/orders/outbox/', { params }),
  
  // Shipments & Tracking
  createShipment: (orderId, data) => api.post(`/orders/${orderId}/shipments/`, data),
  getShipments: (orderId) => api.get(`/orders/${orderId}/shipments/`),
  updateShipmentStatus: (shipmentId, status, notes = '', carrier = '', tracking_code = '', estimated_delivery_date = null) => 
...
export const inventoryService = {
  ...
  initProductInventory: (data) => api.post('/inventory/items/init-product/', data),
