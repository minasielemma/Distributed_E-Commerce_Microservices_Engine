...
class OrderServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.MarkOrderPaid = channel.unary_unary(
                ...
                request_serializer=order__pb2.MarkPaidRequest.SerializeToString,
                response_deserializer=order__pb2.MarkPaidResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'MarkOrderPaid': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.MarkPaidRequest.FromString,
                    response_serializer=order__pb2.MarkPaidResponse.SerializeToString,
            ),
    }
...
class OrderService:
    ...
    def MarkOrderPaid(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/MarkOrderPaid',
            order__pb2.MarkPaidRequest.SerializeToString,
            order__pb2.MarkPaidResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
