...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-payment-service-secret-key")
DEBUG = True
import re
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'payment_pass'),
        'HOST': os.getenv('POSTGRES_HOST', 'payment_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'OpenAPI 3.0 microservice specification for Payments and Transactions Service',
    'VERSION': '1.0.0',
