...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-finance-service-secret-key")
DEBUG = True
import re
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('POSTGRES_HOST', 'finance_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'OpenAPI 3.0 microservice specification for Finance, Invoicing, and Accounting Service',
    'VERSION': '1.0.0',
