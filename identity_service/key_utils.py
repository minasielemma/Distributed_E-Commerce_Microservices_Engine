...
def signed_cert(cn, ca_key, ca_cert, is_server=False):
    ...
    if is_server:
        sans = [
            ...
            x509.DNSName("catalog-service"),
            x509.DNSName("cart_service"),
            x509.DNSName("cart-service"),
            x509.DNSName("identity_service"),
            x509.DNSName("identity-service"),
            x509.DNSName("inventory_service"),
            x509.DNSName("inventory-service"),
            x509.DNSName("order_service"),
            x509.DNSName("order-service"),
            x509.DNSName("payment_service"),
            x509.DNSName("payment-service"),
            x509.DNSName("finance_service"),
            x509.DNSName("finance-service"),
            x509.DNSName("recommendation_service"),
            x509.DNSName("recommendation-service"),
            x509.DNSName("media_service"),
            x509.DNSName("media-service"),
            x509.DNSName("chat_service"),
            x509.DNSName("chat-service"),
            x509.DNSName("notification_service"),
            x509.DNSName("notification-service"),
