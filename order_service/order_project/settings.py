...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-order-service-secret-key")
DEBUG = True
import re
...
ASGI_APPLICATION = 'order_project.asgi.application'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': [{
                'address': os.getenv('REDIS_URL', f'redis://{REDIS_HOST}:{REDIS_PORT}/0'),
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'order_pass'),
        'HOST': os.getenv('POSTGRES_HOST', 'order_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'OpenAPI 3.0 microservice specification for Orders, Checkout, and Order Processing Service',
    'VERSION': '1.0.0',
