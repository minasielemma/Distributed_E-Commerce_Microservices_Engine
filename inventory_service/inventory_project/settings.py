...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-inventory-service-secret-key")
DEBUG = True
import re
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('POSTGRES_HOST', 'inventory_db'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'OpenAPI 3.0 microservice specification for Inventory, Stock, and Warehouses Service',
    'VERSION': '1.0.0',
